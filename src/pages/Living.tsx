...
export default function Living(){
  ...
  return (
    <Layout>
      <HeroCover title={copy.living.hero} />
      <Section>
        <Container>
          <FadeStagger>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
              {copy.living.categories.map((c, i) => (
                <FadeItem key={i}>
                  <div className="rounded-2xl overflow-hidden bg-white border border-[#E5E5E5]">
                    <img src={`https://source.unsplash.com/1600x900/?livingroom,modern,${i}`} alt="Living" loading="lazy" className="h-64 w-full object-cover"/>
